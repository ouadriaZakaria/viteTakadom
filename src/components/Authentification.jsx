...
const AuthPage = ({ role, onBack, isOpen, onClose, onSubmit }) => {
      ...
      >
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Connexion {roleLabel}</h2>
          </div>
          <button 
            onClick={onClose}
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="flex justify-end mt-1">
                <a href="#" className="text-sm text-green-600 hover:text-green-800">Mot de passe oublié?</a>
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-white font-medium transition-all duration-300"
              style={{ background: 'linear-gradient(45deg, #00c853, #64dd17)' }}
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white font-medium text-gray-700 hover:bg-gray-50 transition-all duration-300"
              style={{
                boxShadow: isHoveredGoogle ? '0 4px 12px rgba(0, 0, 0, 0.1)' : '0 1px 3px rgba(0, 0, 0, 0.05)'
              }}
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white font-medium text-gray-700 hover:bg-gray-50 transition-all duration-300"
              style={{
                boxShadow: isHoveredEmail ? '0 4px 12px rgba(0, 0, 0, 0.1)' : '0 1px 3px rgba(0, 0, 0, 0.05)'
              }}
            >
